...
function selectExperiments($galaxy)
{
	...
	$content .= "<input type=\"checkbox\" name=\"samplename\" \> Include samplenames in projectnames.";
...
// 	echo $aData;
	...
	$content .= "<input type=\"hidden\" name=\"platform\" value=\"SOLiD4\">";

	$content .= "<h3>Path to working directory on " . $configuration['SUBMITNODE'] . ":</h3>\n";
	$content .= "<input type=\"text\" name=\"pwd\" size=50 value=\"/data/mapping/\">";
...
// 			echo "R3<br />";
			...
			$quality = preg_replace("/^(.+)_F5-BC/", "$1_F5-BC_QV", $quality);
