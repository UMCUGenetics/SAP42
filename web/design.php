...
function content($page)
{
	...
	$content .= "<div class='startmappingfloat'><a href='design.php?page=add'>Add designfile settings</a></div>";

	$content .= "<div class='startmappingfloat'><a href='design.php?page=edit'>Change designfile list</a></div>";
...
function add()
{
	...
	$content .= "Example: ExonEnrichment_150K	/data/person/designs/ee_150K.bed \n";
...
function save()
{
	...
	$file = fopen("design.txt", "a") or exit("Unable to save to file!");
...
function store()
{
	...
	$file = fopen("design.txt", "w") or exit("Unable to save to file!");
